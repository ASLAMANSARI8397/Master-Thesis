...
The system uses **Plotly Express** to create a dynamic scatter plot of person location over time, where:

- X-axis = `angle_deg`
- Y-axis = `distance_cm`
- Color = Encodes proximity-based safety zone

Zone coloring is defined as:

- **Red** for distance < 100 cm (Danger zone)
- **Yellow** for 100-200 cm (Caution)
- **Green** for > 200 cm (Safe)
...
This interactive plot allows stakeholders to identify high-risk angles and distances visually.
...
This feature makes the analysis extremely intuitive and non-technical users can interpret risks visually.
...
- Smooths out jitter in distance and angle readings.
